...
class UsersAppModel extends MercuryRestModel
{
  ...
  {
    return AxelradUserMgmt::get_groups();
  }
  
  public static function memberships_fetch($data)
  {
    return AxelradUserMgmt::get_user_memberships($data['user_id']);
  }
  
  public static function membership_delete($data)
  {
    return AxelradUserMgmt::rmv_group_member($data['group_name'], $data['user_id']);
  }
  
  public static function membership_create($data)
  {
    return AxelradUserMgmt::add_group_member($data['group_name'], $data['user_id']);
  }
